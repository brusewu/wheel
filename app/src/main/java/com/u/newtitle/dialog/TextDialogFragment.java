...
public class TextDialogFragment extends DialogFragment {
    ...
    public void onStart() {
        super.onStart();
        if (mDialogView != null) mDialogView.startAnimation(mAnimIn);
    }

    @Override
    public void dismiss() {
        super.dismiss();
        if (mDialogView != null) mDialogView.startAnimation(mAnimOut);
    ...
    public void setDownTimer(long seconds, boolean isConfirm) {
        if (mDownTimer == null) {
            mDownTimer = new MyDownTimer(seconds * 1000, isConfirm);
        }
        mDownTimer.start();
    }
